...
public class CMSSecurityConfig extends WebSecurityConfigurerAdapter {
    final private String[] ignorelist = {"/","/home","/index","/error","/login",
        ...
        "/events/editEventAdvertisement","/events/eventAdministratorList",
        "/events/addEventAdministrator","/events/editEventAdministrator",
        "/events/editEventAdministrator/*","/events/editEventAdvertisement/*",
        "/events/editEvent/*","/reviews/editReview/*",
        "/aiml/mlAlgorithms","/aiml/aiAlgorithms",
