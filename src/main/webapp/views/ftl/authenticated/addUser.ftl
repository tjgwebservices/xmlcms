      ...
      <div>
         <fieldset>
            ...
            <form name="user" action="" method="POST">
               ...
               <p><textarea id="content1" name="content1" value="">${userForm.content1}</textarea></p>
               <p>In what ways can you benefit from consulting services:</p>
               <p><textarea id="content2" name="content2" value="">${userForm.content2}</textarea></p>
               <p>What new features would you like to be added to this application:</p>
               <p><textarea id="content3" name="content3" value="">${userForm.content3}</textarea></p>
              <br/>
               <br/>
