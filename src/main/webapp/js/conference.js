...
document.getElementById("countdown").innerHTML = "African American History Month starts in: " + days + "d " + hours + "h "
+ minutes + "m " + seconds + "s ";
if (distance < 0) {
	clearInterval(x);
	document.getElementById("countdown").innerHTML = "Welcome to African American History Month  2021 - Resources";
}
}, 1000);
