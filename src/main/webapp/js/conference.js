...
var countDownDate = new Date("Jan 11, 2021 08:00:00").getTime();
...
document.getElementById("countdown").innerHTML = "HATC 2021 starts in: " + days + "d " + hours + "h "
+ minutes + "m " + seconds + "s ";
if (distance < 0) {
	clearInterval(x);
	document.getElementById("countdown").innerHTML = "Welcome to HATC 2021";
}
}, 1000);
