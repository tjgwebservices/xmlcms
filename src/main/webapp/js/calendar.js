...
var inputCalendarStartDate = document.querySelector("input#startDate");
var inputCalendarEndDate = document.querySelector("input#endDate");
var inputCalendarAuthorDate = document.querySelector("input#authorDate");

if (inputCalendarStartDate === null || inputCalendarStartDate === undefined){
   
   
} else {
    inputCalendarStartDate.addEventListener("click", function(e){
       e.preventDefault();
       calendarInit();
       inputCalendarStartDate.value = months[d.getMonth()] + " " + currentDate[2] + ", " + currentDate[0];
       inputCalendarStartDate.parentElement.appendChild(createCurrentDay());       
       inputCalendarStartDate.parentElement.appendChild(createCalendar());
...
if (inputCalendarEndDate === null || inputCalendarEndDate === undefined){
   
   
} else {
    inputCalendarEndDate.addEventListener("click", function(e){
       e.preventDefault();
       calendarInit();
       inputCalendarEndDate.value = months[d.getMonth()] + " " + currentDate[2] + ", " + currentDate[0];
    });

}


if (inputCalendarAuthorDate === null || inputCalendarAuthorDate === undefined){
   
   
} else {
    inputCalendarAuthorDate.addEventListener("click", function(e){
       e.preventDefault();
       calendarInit();
       inputCalendarAuthorDate.value = months[d.getMonth()] + " " + currentDate[2] + ", " + currentDate[0];
    });
...
function createCalendarHeader(){
    ...
    titlespan.innerHTML = "Select Date";
